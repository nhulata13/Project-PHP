...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Truy vấn như cách bạn vẫn dùng
    $sql = "INSERT INTO service (ServiceName, Description, Date, Imgsrc)
            VALUES ('$name', '$description', '$date', '$imgsrc')";
    ...
    <div class="section">
		...
		<div class="container container-admin">
			...
			<div class="row row-admin">
                <div class="col-md-12">
                        <h2 class="text-center">Thêm Dịch Vụ Mới</h2>
